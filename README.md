...
`bkdetect` - библиотека для поиска совпадающих фрагментов запроса в текстовых корпусах.
---
